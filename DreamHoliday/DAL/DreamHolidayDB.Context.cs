...
namespace DreamHoliday.DAL
{
    ...
    public partial class DreamHollidayEntities : DbContext
    {
        ...
        public virtual ObjectResult<detailBienWithId_Result> detailBienWithId(Nullable<int> idBien)
        {
            var idBienParameter = idBien.HasValue ?
                new ObjectParameter("idBien", idBien) :
                new ObjectParameter("idBien", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<detailBienWithId_Result>("detailBienWithId", idBienParameter);
        }
    
        public virtual int VerifSiDateEstDispo(Nullable<int> idBien, Nullable<System.DateTime> dateArrivee, Nullable<System.DateTime> dateDepart)
        {
            var idBienParameter = idBien.HasValue ?
                new ObjectParameter("idBien", idBien) :
                new ObjectParameter("idBien", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("VerifSiDateEstDispo", idBienParameter, dateArriveeParameter, dateDepartParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> VerifSiDateEstDispo21(Nullable<int> idBien, Nullable<System.DateTime> dateArrivee, Nullable<System.DateTime> dateDepart)
        {
            var idBienParameter = idBien.HasValue ?
                new ObjectParameter("idBien", idBien) :
                new ObjectParameter("idBien", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("VerifSiDateEstDispo21", idBienParameter, dateArriveeParameter, dateDepartParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> VerifSiDateEstDispos1(Nullable<int> idBien, Nullable<System.DateTime> dateArrivee, Nullable<System.DateTime> dateDepart)
        {
            var idBienParameter = idBien.HasValue ?
                new ObjectParameter("idBien", idBien) :
                new ObjectParameter("idBien", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("VerifSiDateEstDispos1", idBienParameter, dateArriveeParameter, dateDepartParameter);
        }
    
        public virtual ObjectResult<detailBienWithId1_Result1> detailBienWithId1(Nullable<int> idBien)
        {
            var idBienParameter = idBien.HasValue ?
                new ObjectParameter("idBien", idBien) :
                new ObjectParameter("idBien", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<detailBienWithId1_Result1>("detailBienWithId1", idBienParameter);
        }
    
        public virtual ObjectResult<detailBienWithId11_Result1> detailBienWithId11(Nullable<int> idBien)
        {
            var idBienParameter = idBien.HasValue ?
                new ObjectParameter("idBien", idBien) :
                new ObjectParameter("idBien", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<detailBienWithId11_Result1>("detailBienWithId11", idBienParameter);
        }
        ...
        public virtual ObjectResult<SearchBiensDispo2_Result2> SearchBiensDispo2(string paysOuVille, Nullable<System.DateTime> arrivee, Nullable<System.DateTime> depart, Nullable<int> nbPers)
        {
            var paysOuVilleParameter = paysOuVille != null ?
                new ObjectParameter("paysOuVille", paysOuVille) :
                new ObjectParameter("paysOuVille", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchBiensDispo2_Result2>("SearchBiensDispo2", paysOuVilleParameter, arriveeParameter, departParameter, nbPersParameter);
        }
        ...
        public virtual int editBien(string pays, string ville, string rue, string numero, Nullable<decimal> tarifNuit, Nullable<decimal> tarifNettoyage, string libelle, string photo, Nullable<int> nbMaxDePers, Nullable<int> sdb, Nullable<int> salon, Nullable<int> sam, Nullable<int> toilette, Nullable<int> cuisine, Nullable<int> chambre, Nullable<int> dressing, Nullable<int> veranda, Nullable<bool> bbq, Nullable<bool> piscine, Nullable<bool> jacuzzi, Nullable<bool> sauna, Nullable<bool> tv, Nullable<bool> teleDistrib, Nullable<bool> wifi, Nullable<bool> pingPong, Nullable<bool> tennis, Nullable<bool> transat, Nullable<bool> cuisineEqu, Nullable<bool> machineALaver, Nullable<bool> jardin, Nullable<bool> parking)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("editBien", paysParameter, villeParameter, rueParameter, numeroParameter, tarifNuitParameter, tarifNettoyageParameter, libelleParameter, photoParameter, nbMaxDePersParameter, sdbParameter, salonParameter, samParameter, toiletteParameter, cuisineParameter, chambreParameter, dressingParameter, verandaParameter, bbqParameter, piscineParameter, jacuzziParameter, saunaParameter, tvParameter, teleDistribParameter, wifiParameter, pingPongParameter, tennisParameter, transatParameter, cuisineEquParameter, machineALaverParameter, jardinParameter, parkingParameter);
        }
    
        public virtual ObjectResult<addNewBiens_Result> addNewBiens(string pays, string ville, string rue, string numero, Nullable<int> idMembre, Nullable<decimal> tarifNuit, Nullable<decimal> tarifNettoyage, string libelle, Nullable<int> nbMaxDePers, Nullable<int> sdb, Nullable<int> salon, Nullable<int> sam, Nullable<int> toilette, Nullable<int> cuisine, Nullable<int> chambre, Nullable<int> dressing, Nullable<int> veranda, Nullable<bool> bbq, Nullable<bool> piscine, Nullable<bool> jacuzzi, Nullable<bool> sauna, Nullable<bool> tv, Nullable<bool> teleDistrib, Nullable<bool> wifi, Nullable<bool> pingPong, Nullable<bool> tennis, Nullable<bool> transat, Nullable<bool> cuisineEqu, Nullable<bool> machineALaver, Nullable<bool> jardin, Nullable<bool> parking)
        {
            var paysParameter = pays != null ?
                new ObjectParameter("pays", pays) :
                new ObjectParameter("pays", typeof(string));
